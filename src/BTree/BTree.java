...
public class BTree<Key extends Comparable<Key>, Value> {
	...
	/*
	 * Поиск по ключу, возващает значение, соответствующее ключу или null, если
	 * ключ не найден
	 */
	...
	/*
	 * Помечает элемент с заданным ключом как удаленный (при этом структура
	 * дерева не изменяется(!)). В дальнейшем доступна вставка по данному ключу.
	 * Возвращает true, если элемент удален и false, если элемент с данным
	 * ключом не найден
	 */
